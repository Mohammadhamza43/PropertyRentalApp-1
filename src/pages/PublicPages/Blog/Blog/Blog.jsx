      ...
      <div className="container">
        <div className="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
          <div className="col-md-9 pb-5 text-center">
          	<p className="breadcrumbs"><span className="mr-2"><a href="index.html">Home <i className="ion-ios-arrow-forward"><MdKeyboardArrowRight/></i></a></span> <span>Blog <i className="ion-ios-arrow-forward"><MdKeyboardArrowRight/></i></span></p>
          ...
          <div className="col-md-3 d-flex">
              ...
              <div className="text">
                ...
                <div className="meta mb-3">
                  <div><a href="#">July. 24, 2019</a></div>
                  <div><a href="#">Admin</a></div>
                  <div><a href="#" className="meta-chat"><span className="icon-chat"><BsChatLeftDotsFill/></span> 3</a></div>
                </div>
